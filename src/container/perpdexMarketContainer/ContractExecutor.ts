...
import { PerpdexMarketActions } from "./type"
...
export class ContractExecutor implements PerpdexMarketActions {
    constructor(readonly contract: PerpdexMarket, readonly signer: Signer | undefined) {
        if (signer) {
